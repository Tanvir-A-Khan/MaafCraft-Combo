                ...
                <div className="flex lg:flex-row flex-col gap-4">
                    ...
                    <strong>Jute: </strong>
                      {" "}
                        ...
                        baskets i.e. Storage, Laundry, Door mat, Floor mat,
                        Table mat, Planter, Coaster, Pouf etc
                    </p>
             
                     <InfoImage 
                         imageUrl="./materials/1p.jpg"
                         productName="Basket!"
                    />
                </div>
                <hr/>
